#!/usr/bin/env python3
"""
Experiment 2: contextual bandit, A*PO Stage 1 — Beta prompt difficulties; LME vs replica estimators (Exp. 1–motivated).

Usage:
    python run_experiment2.py
    python run_experiment2.py --quick

Outputs: results/experiment2/YYYY-MM-DD_HH-MM-SS/
"""
...
SINGLE_N_VALUES = [4, 8]
MULTI_N_SETS = [
    [2, 4, 6, 8],  # best overall non-LME in sparse Bernoulli (Exp. 1)
    [2, 3, 4],     # best at very low N (e.g. N=4)
]
